...
public class UsuarioDAO implements ICRUD<Usuario> {
    ...
    public Usuario login(String correo, String contrasena) {
        final String SQL = "SELECT * FROM Usuario WHERE Correo_Electronico = ? AND Contrasena_Hash = ?";
        Usuario usuario = null;
        try {
            ...
            if (res.next()) {
                usuario = new Usuario.Builder()
                        ...
                        .fechaRegistro(res.getTimestamp("Fecha_Registro"))
                        .build();
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (res.next()) {
                usuario = new Usuario.Builder()
                        ...
                        .nombreCompleto(res.getString("Nombre_Completo"))
                        .correoElectronico(res.getString("Correo_Electronico"))
                        .contrasenaHash(res.getString("Contrasena_Hash")) // Temporalmente
                        .rol(res.getString("Rol")) 
                        .fechaRegistro(res.getTimestamp("Fecha_Registro"))
                        .build();
            }
